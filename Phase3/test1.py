...
def final_check(in_str: str, alphabets: List[str], final_states: List[str], initial_state: str, transitions: List[Tuple[str, str, str]]) -> bool:
    current = set()
...
def Finite_automata():
    ...
    for state, transitions in Fa['transitions'].items():
        for symbol in transitions.keys():
            # Fa_transitions.append((state, symbol, transitions[symbol]))
...
if __name__ == '__main__':
    ...
    # input_states = input().strip('{} \t\n\r')
    # input_alphabet = input().strip('{} \t\n\r')
    # input_final_states = input().strip('{} \t\n\r')
    # input_transitions_no = int(input().strip('{} \t\n\r'))
    ...
    #     input_transitions.append(input().strip())
